		...
		<div id="signup">
			...
			<form name="registro" action="./classes/login-e-registro.php" method="post">
				...
				<div class="field-wrap">
					...
					<input name="telefone" type="password" id="telefone-registro" maxlength="15" required autocomplete="off" />
				</div>
		...
		<div style="display: none;" id="login">
			...
			<form name="logar" action="./classes/login-e-registro.php" method="post">
				...
				<div class="field-wrap">
					...
					<input name="telefone" type="password" id="telefone-login" maxlength="15" required autocomplete="off"/>
				</div>
				<p class="forgot">
